...
On souhaite notamment questionner le choix du sujet, du laboratoire, de l'équipe de recherche et du directement de thèse. Quelles sont les priorités du doctorant lorsqu'il a a choisi ceux-ci ? Quels paramètres entre en compte dans ses choix ? Le contact avec le monde de l'entreprise était-il un critère ?

En effet nous souhaitons réfléchir sur ses choix du doctorant dans l'optique d'une poursuite de carrière dans le privée ou le public. Nous souhaiterions donc savoir si le doctorant avait déjà une idée de ce qu'il ou elle souhaiterait faire après sa thèse. Si c'est le cas nous nous demanderons si cela a influencé les choix effectués avant la thèse, et si oui comment ? Le choix d'un sujet et de modalités impliquant de forts liens avec l'entreprise, comme par exemple une thèse cifre, pourrais être envisagé pour garder contact avec le privé. Au contraire, existe-t-il des choix qui sont favorisés pour poursuivre une carrère dans le public ?
...
% Faire la liste plus en détail des modalités possibles à ces moments-là sur lesquelles ont va poser des questions.
